...
class Main:
    ...
    def main():
        ...
        roomNames = []
        rooms = []
        with open('~/story_files/roomsList.txt', encoding="utf-8") as f:
            line = f.readline()
            while line:
        ...
        for r in roomNames:
            ...
            neighbors = []
            with open('~/story_files/' + r + 'Neighbors.txt', encoding="utf-8") as f:
                line = f.readline()
                while line:
                    if line == "None":
            ...
            with open('~/story_files/' + r + 'Desc.txt', encoding="utf-8") as f:
                description = f.read() 
